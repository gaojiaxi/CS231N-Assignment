...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        ############################################################################
        X_reshaped=X.reshape(X.shape[0],self.D)
        W1=self.params['W1']
        b1=self.params['b1']
        W2=self.params['W2']
        b2=self.params['b2']
        reg=self.reg
        hidden_layer_out, cache_hidden_layer = affine_relu_forward(X_reshaped, W1, b1)
        scores,cache_scores=affine_forward(hidden_layer_out, W2, b2)
        pass
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        _, dW1, db1=affine_relu_backward(dA1, cache_hidden_layer)
        dW2+=self.reg*W2
        dW1+=self.reg*W1
        grads['W1']=dW1
        grads['W2']=dW2
